namespace Skyline.DataMiner.Utils.UnitTestingFramework.DataMinerSystem.Common.Tests
{
    ...
    public class DmsTableMockTests
    {
        ...
        [TestMethod]
        public void AddRow_AddsRowAndReturnsPrimaryKey_WithValidRow()
        {
            // Arrange
        ...
        [TestMethod]
        public void AllRows_ReturnsEveryRow_AfterRowsAdded()
        {
            var tableMock = new IDmsMock().CreateAgent(0).CreateElement(path).GetDmsTableMock(900);
            ...
            Assert.AreEqual(2, tableMock.AllRows.Count);
        }

        [TestMethod]
        public void Constructor_ThrowsArgumentNullException_WithNullTableModel()
        {
            Assert.ThrowsExactly<ArgumentNullException>(() => new DmsTableMock(null, null));
        }

        [TestMethod]
        public void DeleteRow_RemovesRow_WithExistingKey()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void DeleteRows_RemovesMultipleRows_WithExistingKeys()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void Element_ReturnsOwningElement_ForRequestedTable()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
        ...
        [TestMethod]
        public void GetAllRows_ReturnsEveryRow_OnTableMock()
        {
            // Arrange
        ...
        [TestMethod]
        public void GetCell_ReturnsCellValue_WithExistingRow()
        {
            var tableMock = new IDmsMock().CreateAgent(0).CreateElement(path).GetDmsTableMock(900);
            tableMock.SetRow(new object[] { "one", "description", 3.0, 4.0, 5.0 });

            Assert.AreEqual("description", tableMock.GetCell("one", 902));
        }

        [TestMethod]
        public void GetColumn_ReturnsColumnWithMatchingId_WithSupportedType()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void GetColumn_ThrowsNotSupportedException_WithUnsupportedType()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void GetData_ReturnsDataKeyedByColumn_WithValidColumnIndex()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void GetData_ThrowsArgumentException_WithInvalidKeyColumnIndex()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void GetRow_ReturnsRowData_WithExistingKey()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void GetRows_ReturnsAllRows_AfterRowsAdded()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void GetRows_ReturnsOnlyRequestedRows_OnTableMock()
        {
            // Arrange
            var elementMock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            elementMock.Object.GetTable(900);
        ...
        [TestMethod]
        public void Id_ReturnsTableId_ForRequestedTable()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
        ...
        [TestMethod]
        public void QueryData_ReturnsAllRows_WithoutFilters()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void QueryData_ReturnsMatchingRows_WithEqualFilter()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void QueryData_ReturnsMatchingRows_WithGreaterThanFilter()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void QueryData_ReturnsSelectedColumns_WithReturnFilter()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void QueryData_ReturnsSelectedColumnsOfMatchingRows_WithCombinedFilters()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void RemoveAllRows_ClearsTable_OnTableMock()
        {
            // Arrange
            var elementMock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            elementMock.Object.GetTable(900);
        ...
        [TestMethod]
        public void RemoveRows_RemovesOnlySpecifiedRow_OnTableMock()
        {
            // Arrange
            var elementMock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            elementMock.Object.GetTable(900);
        ...
        [TestMethod]
        public void RowCount_ReturnsNumberOfRows_AfterRowsAdded()
        {
            var tableMock = new IDmsMock().CreateAgent(0).CreateElement(path).GetDmsTableMock(900);
            tableMock.SetRows(new[]
            {
        ...
        [TestMethod]
        public void SetCell_UpdatesOneCell_OnTableMock()
        {
            // Arrange
            var elementMock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            elementMock.Object.GetTable(900);
        ...
        [TestMethod]
        public void SetCells_UpdatesSameColumnInMultipleRows_OnTableMock()
        {
            // Arrange
            var elementMock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            elementMock.Object.GetTable(900);
        ...
        [TestMethod]
        public void SetRow_AddsReadableRow_OnTableMock()
        {
            // Arrange
        ...
        [TestMethod]
        public void SetRow_UpdatesExistingRow_WithMatchingPrimaryKey()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void SetRow_UsesPrimaryKeyArgument_WithDifferentKeyInData()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void SetRows_AddsAndUpdatesRows_OnTableMock()
        {
            // Arrange
            var elementMock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            elementMock.Object.GetTable(900);
        ...
        [TestMethod]
        public void StartValueMonitor_InvokesCallbackOnRowAdded_WithColumnIndexesAndTimeSpanOverload()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void StartValueMonitor_InvokesCallbackOnRowAdded_WithColumnIndexesOverload()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void StartValueMonitor_InvokesCallbackOnRowAdded_WithDefaultOverload()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void StartValueMonitor_InvokesCallbackOnRowAdded_WithTimeSpanOverload()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        [TestMethod]
        public void StartValueMonitor_InvokesCallbackOnRowDeleted_WithDefaultOverload()
        {
            // Arrange
            var mock = new IDmsMock().CreateAgent(agentId: 0).CreateElement(path);
            var table = mock.Object.GetTable(900);
        ...
        {
            // Arrange
            var table = new IDmsMock().CreateAgent(0).CreateElement(path).Object.GetTable(900);
            var firstInvocations = 0;
            var secondInvocations = 0;
            table.StartValueMonitor("source", 0, change => firstInvocations++, false);
            table.StartValueMonitor("source", 0, change => secondInvocations++, false);
        ...
        public void StartValueMonitor_ThrowsArgumentNullException_WithNullCallback()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(() =>
                table.StartValueMonitor("source", 0, null, false));
        }
        ...
        public void StartValueMonitor_ThrowsArgumentNullException_WithNullSourceId()
        {
            ...
            Assert.ThrowsExactly<ArgumentNullException>(() =>
                table.StartValueMonitor(null, 0, change => { }, false));
        }
